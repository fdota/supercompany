  ...
  const rightContent = (
    <div className="flex flex-col justify-center h-full p-4">
      <div className="font-mono text-sm lg:text-base text-right-color leading-relaxed space-y-6 max-w-md mx-auto">
        ...
        <p className="text-supercompany-magenta">Non ho figli e non so se ne avro', ma mi piacerebbe poter dire che sono stato il "La" di qualcosa molto piu' grande di me.</p>
        <p className="font-bold text-supercompany-green">Buon viaggio a chi salira' a bordo!</p>
      </div>
    </div>
  );
